...
plot_pfi_coxph <- plot_fi(df_pfi_coxph)
plot_pfi_coxph
...
# create custom plot of permutation feature importance over time
plot_pfi_ranger <- plot_fi(df_pfi_ranger, model = "ranger")
plot_pfi_ranger
...
pdp_ice_grid_uc <-
    ...
    theme(plot.margin = margin(0.1, 0.1, 0.4, 0.1, "cm"))
pdp_ice_grid_uc # Figure

# save grid of uncentered ice and pdp plots
ggsave(
    fig("pdp_ice_grid_uc_sim.pdf"),
